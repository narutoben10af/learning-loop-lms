...
|     5 | `feat/assessment-question-bank-core`                                                                           | Versioned question schemas plus canonical assessment identity, parts/attempts, taxonomy, grading-group projection, draft/validate/release checklist                                              | PR 4                                       | Next             | No duplicate/temporary grade columns; preview isolated; original content; lifecycle/search fixtures                                    |
