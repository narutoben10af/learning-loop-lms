...
|     2 | `feat/data-driven-economics-graph`                                                                      | Reusable declarative graph schema, measured layout/scales/ticks/collision engine, e-bike scenario, constrained pointer/keyboard/native controls                                             | PR 1                                       | In progress      | Graph acceptance criteria 23–29; responsive visual and geometry tests                                            |
