...
|    2a | `ci/public-prototype-pages`                                                                             | Static GitHub Pages deployment from a green `main` commit, repository-path build configuration, public-demo/privacy documentation                                                           | PR 2                                       | In progress      | No secrets/backend/analytics; correct asset base; deployed smoke check; prototype warning remains visible        |
