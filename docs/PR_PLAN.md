...
|     6 | `feat/workspace-course-dashboard`                                                                              | My workspace first screen, course cards/status, role-appropriate recent teaching signals, accessible Create Course and course selection                                                          | PR 5                                       | In progress      | Teacher can create/select/return; student sees no create/teacher signals; 320/375/desktop; no dead controls                                |
