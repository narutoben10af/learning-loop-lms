...
|     2 | [`feat/data-driven-economics-graph` — PR #6](https://github.com/narutoben10af/learning-loop-lms/pull/6) | Reusable declarative graph schema, measured layout/scales/ticks/collision engine, e-bike scenario, constrained pointer/keyboard/native controls                                             | PR 1                                       | Review / checks  | Graph acceptance criteria 23–29; responsive visual and geometry tests                                            |
