...
|     5 | [`feat/workspace-course-domain` — PR #16](https://github.com/narutoben10af/learning-loop-lms/pull/16)          | Versioned workspace state, course identity/lifecycle, membership roles, create/select/archive-safe commands, projections, persistence migration, shared integration seams                        | PR 15                                      | In review        | Multiple courses; immutable IDs; role-bound projections; malformed state fails safely; adapters remain permissioned/audited/replaceable    |
