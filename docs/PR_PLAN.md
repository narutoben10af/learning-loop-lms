...
|     5 | `feat/workspace-course-domain`                                                                                 | Versioned workspace state, course identity/lifecycle, membership roles, create/select/archive-safe commands, projections, persistence migration, shared integration seams                        | PR 15                                      | In progress      | Multiple courses; immutable IDs; role-bound projections; malformed state fails safely; adapters remain permissioned/audited/replaceable    |
