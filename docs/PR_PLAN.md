...
| ----: | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ | -------------- | ---------------------------------------------------------------------------------------------------------------- |
|     0 | [`foundation/repository-governance` — PR #1](https://github.com/narutoben10af/learning-loop-lms/pull/1) | Public repo metadata, README, Apache-2.0 license, contributing/conduct/security/privacy docs, architecture docs, PR templates, initial TypeScript web toolchain, stable CI, branch settings | Corrected visual approval                  | Ready to merge | Repository public; checks green; `main` protected; no product feature breadth                                    |
